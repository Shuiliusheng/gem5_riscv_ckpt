...
if [[ "$ARGC" < 3 ]]
then
    echo "./xxx.sh 400.perlbench(400, perlbench) number(ref=1,2...) (arm riscv mips alpha amd64) "
    exit
fi
...
debug_flag="" #--debug-flags=ShowCMOVAssembly
...
gem5_output_dir=$gem5_output_dir/$target/update-$ISA-$target-"input"$2-$curTime
